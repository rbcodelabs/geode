...
export function createLegacyGeodeFacade(host: HostServices): GeodeApi {
  ...
  return {
    ...
    readSecret: (namespace, key) => host.secrets.get(namespace, key),
    writeSecret: (namespace, key, value) => host.secrets.set(namespace, key, value),
    removeSecret: (namespace, key) => host.secrets.remove(namespace, key),
